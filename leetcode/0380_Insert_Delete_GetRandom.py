...
class RandomizedSet:
    ...
    def insert(self, val: int) -> bool:
        if val not in self.hashSet:
            ...
            self.hashSet[val] = len(self.array) - 1
            return True
        return False
    ...
    def remove(self, val: int) -> bool:
        if val in self.hashSet:
            ...
            self.hashSet[self.array[-1]] = index
            self.array.pop()
...
def main():
    hashSet = RandomizedSet()
    print(hashSet.insert(1))
    print(hashSet.remove(2))
    print(hashSet.insert(2))
    print(hashSet.getRandom())
